...
def addCoupon(request):
    if request.method=="POST":
        ...
        try:
            ...
            client = Client(a,b)    
            client.messages.create(body='Dear Sir/Madam,Thank you for shopping with Shubhamasthu Shopping Mall. Click this link to redeem shubhamasthu.herokuapp.com/scratch/'+obj.link,from_='+19093216268',to='+91'+str(mobile))
            storage = messages.get_messages(request)
            storage.used = True
